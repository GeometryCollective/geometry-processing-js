...
class SimplicialComplexOperators {
        ...
        /** Returns true if the given subset is homogeneous and false otherwise.
         * @method module:Projects.SimplicialComplexOperators#isHomogeneous
         * @param {module:Core.MeshSubset} subset A subset of our mesh.
         * @returns {boolean} True if the given subset is homogeneous and false otherwise.
         */
        isHomogeneous(subset) {
                return (subset.vertices.size == 0 && subset.edges.size == 0)
                        || (subset.edges.size == 0 && subset.faces.size == 0)
                        || (subset.faces.size == 0 && subset.vertices.size == 0);
        }
        ...
        /** Returns the interior of a subset.
         * @method module:Projects.SimplicialComplexOperators#interior
         * @param {module:Core.MeshSubset} subset A subset of our mesh. We assume <code>subset</code> is a pure subcomplex.
         * @returns {module:Core.MeshSubset} The interior of the given pure subcomplex.
         */
        interior(subset) {
                let interior = MeshSubset.deepCopy(subset);
                interior.deleteSubset(this.boundary(interior));
                return interior;
        }
